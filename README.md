...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 30px;">
  <a href="https://www.arduino.cc/" target="_blank" rel="noreferrer" style="padding:30px" width="100"> <img src="https://cdn.worldvectorlogo.com/logos/arduino-1.svg" alt="arduino" width="100" height="40" margin="20"/> </a>
