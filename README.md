...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 30px;">
  ...
  <a href="https://flutter.dev" target="_blank" rel="noreferrer" width="60" height="30" > <img src="https://www.vectorlogo.zone/logos/flutterio/flutterio-icon.svg" alt="flutter" height="100%"/> </a> 
